...
class _CreateTripScreenState extends State<CreateTripScreen> {
  static const String _tag = 'CreateTripScreen';
  ...
  Future<void> _createTrip() async {
    ...
    if (user == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Please login to create a trip'),
          backgroundColor: AppColors.error,
        ),
      );
      return;
    ...
    try {
      ...
      if (tripId != null) {
        AppLogger.info(_tag, 'Trip created successfully', {'tripId': tripId});
      ...
      AppLogger.error(_tag, 'Error creating trip', e, stackTrace);

      if (!mounted) return;

      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('An error occurred while creating trip'),
          backgroundColor: AppColors.error,
        ),
      );
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Create Trip', style: AppTextStyles.headlineSmall),
